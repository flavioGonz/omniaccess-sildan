...
export default function PanicButtonTab() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[500px] space-y-12 animate-in fade-in duration-700">
            <div className="text-center space-y-4">
                <div className="flex items-center justify-center gap-4 mb-2">
                    <div className={cn(
                        ...
                        isAlertMode ? "bg-red-500/20 border-red-500/50 shadow-2xl shadow-red-500/20" : "bg-neutral-900 border-neutral-800"
                    )}>
                        <Shield className={cn(isAlertMode ? "text-red-500" : "text-neutral-500")} size={48} />
                    </div>
                </div>
                <h2 className="text-4xl font-black text-white uppercase tracking-tighter">Centro de Emergencias</h2>
                <p className="text-xs text-neutral-500 font-bold uppercase tracking-[0.3em]">Protocolo de seguridad omniaccess</p>
            </div>
                    ...
                    {isAlertMode ? (
                        ...
                        >
                            <div className="relative group">
                                ...
                                >
                                    <Siren size={80} className="text-white mb-4 animate-bounce" />
                                    <span className="text-xs font-black text-white uppercase tracking-[0.2em]">Pánico</span>
            ...
            <div className="grid grid-cols-3 gap-6 w-full max-w-2xl pt-8 border-t border-neutral-800/50">
                <div className="text-center py-4 px-6 rounded-3xl bg-neutral-900/40 border border-neutral-800/50">
                    <p className="text-[10px] font-black text-neutral-600 uppercase tracking-widest mb-2">Estado</p>
                ...
                <div className="text-center py-4 px-6 rounded-3xl bg-neutral-900/40 border border-neutral-800/50">
                    <p className="text-[10px] font-black text-neutral-600 uppercase tracking-widest mb-2">Protocolo</p>
                    <p className="text-xs font-black text-white uppercase tracking-widest">Nivel 4</p>
                </div>
                <div className="text-center py-4 px-6 rounded-3xl bg-neutral-900/40 border border-neutral-800/50">
                    <p className="text-[10px] font-black text-neutral-600 uppercase tracking-widest mb-2">Conexión</p>
                    <div className="flex items-center justify-center gap-2">
                        <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                        <p className="text-xs font-black text-white uppercase tracking-widest">Estable</p>
                    </div>
                </div>
            </div>
        </div>
