...
export default function BitacoraCard({ entry }: BitacoraCardProps) {
    ...
    return (
        <>
            <motion.div
                layout
                className="group bg-neutral-900 border border-neutral-800 rounded-[2rem] overflow-hidden hover:border-blue-500/40 transition-all shadow-xl hover:shadow-blue-500/5 h-full flex flex-col"
            >
                    ...
                    <div className="space-y-3 pt-2 border-t border-neutral-800/50">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 overflow-hidden">
                                ...
                                <p className="text-xs font-bold text-white truncate">{entry.guardName || entry.guard?.name || 'Sistema'}</p>
                            </div>
                        </div>
                    </div>
