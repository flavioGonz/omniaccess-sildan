...
export default function GuardIphoneConsole({
    ...
    useEffect(() => {
        if (isAlertMode) {
            if (!alarmAudioRef.current) {
                alarmAudioRef.current = new Audio("/sounds/alarm_clock.ogg");
            ...
            {activeTab !== "faces" && (
                <header className="h-16 bg-white border-b border-slate-200 px-6 flex items-center justify-between shrink-0 z-50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-sm font-bold uppercase tracking-tight">Omniaccess Guard</h1>
                    ...
                    <div className="flex items-center gap-2">
                        {isAlertMode && (
                            <div className="px-3 py-1 bg-red-600 text-white rounded-full text-[10px] font-bold animate-pulse flex items-center gap-1.5">
            ...
            <main className="flex-1 overflow-hidden relative">
                <AnimatePresence mode="wait">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="p-1 bg-slate-200/50 rounded-2xl flex gap-1">
                                    <button
                                        ...
                                        className={cn(
                                            "flex-1 py-3 rounded-xl flex items-center justify-center gap-2 text-xs font-bold uppercase transition-all",
                                ...
                                <div className="space-y-4">
                                    <Label className="text-[10px] font-bold uppercase text-slate-400 tracking-widest block text-center">Matrícula Detectada</Label>
                                ...
                                <div className="space-y-4">
                                        ...
                                        {showSuggestions && userSuggestions.length > 0 && (
                                            ...
                                            >
                                                <div className="p-3 bg-blue-50 border-b border-blue-100">
                                                    <p className="text-[10px] font-bold uppercase text-blue-600 tracking-widest flex items-center gap-2">
                                                                    ...
                                                                    {user.vehicles?.length > 0 && (
                                                                        <div className="flex gap-1 mt-1 flex-wrap">
                                                                            {user.vehicles.map((v: any, i: number) => (
                                                                                <span key={i} className="px-2 py-0.5 bg-slate-100 rounded text-[9px] font-bold text-slate-600">
                                                                                    {v.plate}
                                                                                </span>
                                                                            ))}
                                                                        </div>
                                                ...
                                                <button
                                                    ...
                                                    className="w-full p-3 bg-slate-50 text-[10px] font-bold uppercase text-slate-400 hover:bg-slate-100 transition-colors"
                                                >
                                                    Cerrar
                                                </button>
                                            </motion.div>
                                    ...
                                    <div className="pt-2 space-y-4">
                                        <div className="flex gap-4">
                                            ...
                                            >
                                                <Camera size={20} />
                                                <span className="text-[10px] font-bold uppercase tracking-widest">{capturedPhoto ? "Cambiar Foto" : "Tomar Foto"}</span>
                                            </button>
                                            <button
                                        ...
                                        <button
                                            ...
                                            className={cn(
                                                "w-full h-16 rounded-2xl font-bold uppercase tracking-[0.2em] text-sm shadow-xl active:scale-95 transition-all flex items-center justify-center gap-3",
                                                type === "ENTRY"
                    ...
                    {activeTab === "history" && (
                        ...
                        >
                            <div className="flex items-center justify-between mb-6">
                                <h2 className="text-xl font-bold uppercase text-slate-900 tracking-tight">Bitácora</h2>
                            </div>
                                ...
                                {(() => {
                                    ...
                                    if (filteredEntries.length === 0) return (
                                        <div className="py-20 text-center opacity-20">
                                            ...
                                            <p className="font-bold uppercase tracking-widest">Sin registros</p>
                                        </div>
                                    );
                                    ...
                                    return filteredEntries.map((entry: any) => (
                                        <button
                                            ...
                                            className="bg-white p-5 rounded-2xl border-2 border-slate-100 shadow-sm flex flex-col gap-4 active:scale-[0.98] transition-all text-left"
                                        >
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex items-center gap-2 mb-0.5">
                                                        <span className="px-2 py-0.5 bg-slate-900 shadow-lg text-white rounded-md text-sm font-bold uppercase tracking-tighter">{entry.plate || "S/N"}</span>
                                                        <span className={cn(
                                            ...
                                            <div className="grid grid-cols-2 gap-2">
                                                <div className="bg-slate-50 rounded-xl p-2 border border-slate-100 flex flex-col justify-center">
                                                    <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest leading-none mb-1">Destino</p>
                                                    <p className="text-[10px] font-bold text-[#B20D30] uppercase truncate">{entry.destination || "---"}</p>
                                                </div>
                                                <div className="bg-slate-50 rounded-xl p-2 border border-slate-100 flex flex-col justify-center">
                                                    <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest leading-none mb-1">Cámara / Origen</p>
                    ...
                    {activeTab === "lpr" && (
                        ...
                        >
                            <div className="flex items-center justify-between mb-6">
                                <h2 className="text-xl font-bold uppercase text-slate-900 tracking-tight">Matrículas LPR</h2>
                                ...
                                {(() => {
                                    ...
                                    if (filteredLpr.length === 0) return (
                                        <div className="py-20 text-center opacity-20">
                                            ...
                                            <p className="font-bold uppercase tracking-widest text-xs">Sin registros LPR</p>
                                        </div>
                                    );
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <span className="px-2 py-0.5 bg-slate-900 text-white rounded-md text-xs font-bold uppercase tracking-tighter">{event.plateDetected || "---"}</span>
                                                    <span className={cn("px-2 py-0.5 rounded-md text-[8px] font-bold uppercase", event.direction === "ENTRY" ? "bg-emerald-50 text-emerald-600" : "bg-orange-50 text-orange-600")}>{event.direction === "ENTRY" ? "Ingreso" : "Egreso"}</span>
                                                </div>
                    ...
                    {activeTab === "alerts" && (
                        ...
                        >
                            <div className="flex items-center justify-between mb-6">
                                <h2 className="text-xl font-bold uppercase text-slate-900 tracking-tight">Eventos Críticos</h2>
                                <div className="flex items-center gap-1">
                                    {isAlertMode && (
                                        <div className="px-3 py-1 bg-red-600 text-white rounded-full text-[9px] font-bold animate-pulse flex items-center gap-1 shadow-lg shadow-red-600/20">
                            ...
                            <button
                                ...
                                className="w-full h-16 mb-8 bg-orange-600 text-white rounded-2xl flex items-center justify-center gap-3 shadow-xl shadow-orange-600/20 active:scale-95 transition-all text-sm font-bold uppercase tracking-widest"
                            >
                                ...
                                {(() => {
                                    ...
                                    if (alertArr.length === 0) return (
                                        <div className="py-20 text-center opacity-20">
                                            ...
                                            <p className="font-bold uppercase tracking-widest text-xs">Sin alertas registradas</p>
                                        </div>
                                    );
                                    return alertArr.map((alert: any) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-xs font-bold uppercase text-slate-900 truncate">{alert.guardName || "Sistema"}</p>
                                                    <p className={cn("text-[9px] font-bold uppercase", isSOS ? "text-orange-600" : "text-red-600")}>{isSOS ? "Sospechoso" : isStillActive ? "Alerta Activa" : "Alerta Resuelta"}</p>
                                                </div>
                                                <div className="text-right shrink-0">
                        ...
                        >
                            <div className="space-y-6">
                                <section className="text-center">
                                    <h2 className="text-xl font-bold uppercase text-slate-900">Sugerir Registro</h2>
                                ...
                                <div className="p-1 bg-slate-200/50 rounded-2xl flex gap-1">
                                    <button
                                        ...
                                        className={cn(
                                            "flex-1 py-3 rounded-xl flex items-center justify-center gap-2 text-[10px] font-bold uppercase transition-all",
                                ...
                                <div className="space-y-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                                    {regType === "HOUSE" ? (
                                        ...
                                        <>
                                            ...
                                            <div className="space-y-2">
                                                <Label className="text-[10px] font-bold uppercase text-slate-400 tracking-widest pl-1">Asociar a Unidad</Label>
                                                <select
                                                    value={regUnitId}
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            "w-full h-16 rounded-2xl font-bold uppercase tracking-[0.2em] shadow-xl transition-all active:scale-[0.98] mt-4 flex items-center justify-center gap-3",
                        ...
                        >
                            <div className="px-5 space-y-6">
                                ...
                                <button
                                    ...
                                    className="w-full h-24 bg-[#B20D30] text-white rounded-2xl flex items-center justify-between px-8 shadow-lg shadow-red-900/20 active:scale-95 transition-all group"
                                >
                                    <div className="text-left">
                                        <h2 className="text-xl font-bold uppercase tracking-tighter">Buscador Biométrico</h2>
                                ...
                                <div className="space-y-4">
                                    <h3 className="text-xs font-bold uppercase text-slate-400 tracking-[0.2em] ml-2 flex items-center gap-2">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        {faceEntries.length > 0 ? faceEntries.map((event) => (
                                            <button
                                                ...
                                                className="aspect-square bg-white rounded-2xl border border-slate-100 overflow-hidden relative group active:scale-95 transition-all shadow-sm"
                                            >
                                                <Image
                                                ...
                                                <div className="absolute bottom-4 left-4 right-4 text-left leading-tight">
                                                    <p className="text-[10px] font-bold text-white uppercase truncate mb-0.5">
                                            ...
                                            <div className="col-span-2 py-20 flex flex-col items-center justify-center text-slate-300">
                                                ...
                                                <p className="text-[10px] font-bold uppercase tracking-widest mt-4">Sin capturas faciales hoy</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
                        ...
                        {faceMatchResult && (
                            ...
                            >
                                <motion.div
                                    ...
                                    animate={{ scale: 1, y: 0 }}
                                    exit={{ scale: 0.9, y: 20 }}
                                    className="w-full max-w-md bg-white rounded-2xl p-8 space-y-8 shadow-lg relative overflow-hidden"
                                ...
                                >
                                    ...
                                    <div className="flex flex-col items-center text-center space-y-4">
                                        <div className="w-32 h-32 rounded-[40px] border-4 border-white shadow-lg overflow-hidden relative">
                                        ...
                                        <div className="space-y-1">
                                            {faceMatchResult.user ? (
                                                <>
                                                    <h3 className="text-3xl font-bold tracking-tighter text-slate-900 leading-none uppercase">{faceMatchResult.user.name}</h3>
                                                ...
                                                <>
                                                    <h3 className="text-3xl font-bold tracking-tighter text-slate-400 leading-none">NO IDENTIFICADO</h3>
                                    ...
                                    {faceMatchResult.user && (
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="bg-slate-50 p-4 rounded-3xl border border-slate-100">
                                                <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest mb-1">Unidad</p>
                                                <p className="text-xs font-bold text-slate-900 uppercase">{faceMatchResult.user.unit?.name || "---"}</p>
                                            </div>
                                            <div className="bg-slate-50 p-4 rounded-3xl border border-slate-100">
                                                <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest mb-1">Categoría</p>
                                                <p className="text-xs font-bold text-slate-900 uppercase">{faceMatchResult.user.role}</p>
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    <button
                                        onClick={() => setFaceMatchResult(null)}
                                        className="w-full h-16 bg-slate-100 text-slate-900 rounded-2xl font-bold uppercase tracking-widest text-xs active:scale-95 transition-all"
                                    >
                                        Cerrar Buscador
                                    </button>
                                </motion.div>
                    ...
                    <div className="flex justify-center -mt-8">
                        ...
                        >
                            <button
                                ...
                                className={cn(
                                    "w-16 h-16 rounded-full shadow-lg flex items-center justify-center transition-all active:scale-95 border-4 border-white overflow-hidden relative group",
                            ...
                            {!isAlertMode && (
                                <motion.div 
                                    ...
                                    className="absolute -top-8 left-1/2 -translate-x-1/2 text-[8px] font-bold uppercase text-red-600 whitespace-nowrap pointer-events-none"
                                >
                            ...
                            {isAlertMode && (
                                <motion.div 
                                    ...
                                    transition={{ repeat: Infinity, duration: 2 }}
                                    className="absolute -bottom-8 left-1/2 -translate-x-1/2 text-[8px] font-bold uppercase text-white whitespace-nowrap pointer-events-none"
                                >
            ...
            <AnimatePresence>
                {showIdentityOverlay && (
                    ...
                    >
                        ...
                        <h2 className="text-3xl font-bold uppercase tracking-tighter text-slate-900 mb-2">Omniaccess Guard</h2>
                        ...
                        <form onSubmit={handleManualLogin} className="w-full max-w-sm space-y-6">
                            ...
                            <button
                                type="submit"
                                className="w-full h-14 bg-[#B20D30] text-white rounded-2xl font-bold uppercase tracking-widest shadow-xl shadow-red-900/20 active:scale-95 transition-all flex items-center justify-center gap-2"
                            >
                ...
                {selectedEntry && (
                    ...
                    >
                        <motion.div
                            ...
                            className="w-full max-h-[85vh] bg-white rounded-t-[40px] p-8 pb-12 shadow-lg space-y-6 overflow-y-auto"
                            onClick={(e) => e.stopPropagation()}
                        >
                            ...
                            <div className="flex items-center justify-between">
                                <div className="space-y-1">
                                    ...
                                    <div className="flex gap-2 flex-wrap">
                                        {selectedEntry._lpr ? (
                                            <>
                                                <span className={cn("text-[9px] font-bold uppercase px-2 py-0.5 rounded-md", selectedEntry.direction === "ENTRY" ? "bg-emerald-50 text-emerald-600" : "bg-orange-50 text-orange-600")}>
                                            ...
                                            return (
                                                <span className={cn(
                                                    "text-[9px] font-bold uppercase px-2 py-0.5 rounded-md flex items-center gap-1",
                                            ...
                                            <span className={cn("text-[9px] font-bold uppercase px-2 py-0.5 rounded-md flex items-center gap-1", selectedEntry.type === "ENTRY" ? "bg-blue-50 text-blue-600" : "bg-orange-50 text-orange-600")}>
                                    ...
                                    {selectedEntry.plate && (
                                        <div className="absolute inset-0 flex items-center justify-center bg-black/5 opacity-0 group-hover/image:opacity-100 transition-opacity">
                                            <button
                                                ...
                                                className="bg-[#B20D30] text-white px-6 py-2.5 rounded-full font-bold uppercase text-[10px] tracking-widest shadow-lg flex items-center gap-2 active:scale-95 transition-all"
                                            >
                            ...
                            {selectedEntry.audioPath && (
                                <div className="flex items-center gap-4 bg-blue-50 p-4 rounded-3xl border border-blue-100">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-[9px] font-bold uppercase text-blue-600 mb-1">Nota de Audio</p>
                                        <audio
                ...
                {showReportModal && (
                    ...
                    >
                        <motion.div
                            ...
                            exit={{ y: "100%" }}
                            transition={{ type: "spring", damping: 25, stiffness: 200 }}
                            className="w-full max-w-lg bg-white rounded-t-[40px] p-8 pb-12 shadow-lg space-y-8"
                            onClick={(e) => e.stopPropagation()}
                        >
                            <div className="flex justify-center">
                            ...
                            <div className="text-center space-y-2">
                                <h3 className="text-3xl font-bold tracking-tighter uppercase text-slate-900 leading-none">Reportar Incidente</h3>
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <Label className="text-[9px] font-bold uppercase text-slate-400 tracking-widest ml-1">Detalles del Incidente</Label>
                                    <Input
                                        value={backupDetail}
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <button
                                        ...
                                        className="h-32 bg-slate-50 border-2 border-slate-100 rounded-2xl flex flex-col items-center justify-center gap-3 transition-all active:scale-95 text-slate-900 group"
                                    >
                                        ...
                                        <span className="text-[10px] font-bold uppercase leading-tight">Individuo<br />Sospechoso</span>
                                    </button>
                                    ...
                                    >
                                        ...
                                        <span className="text-[10px] font-bold uppercase leading-tight">Vehículo<br />Sospechoso</span>
                                    </button>
                                    ...
                                    >
                                        <ShieldAlert size={24} />
                                        <span className="text-sm font-bold uppercase tracking-widest">Solicitar Apoyo</span>
                                    </button>
                                </div>
                            </div>
                            ...
                            <button
                                ...
                                className="w-full py-4 text-[10px] font-bold uppercase text-slate-400 hover:text-slate-900 transition-colors"
                            >
                                Cancelar
                            </button>
                        </motion.div>
                ...
                {showResolutionModal && activeMission && (
                    ...
                    >
                        <motion.div
                            ...
                            animate={{ y: 0 }}
                            exit={{ y: "100%" }}
                            className="bg-white w-full max-w-md rounded-t-[3rem] sm:rounded-2xl p-8 pb-12 sm:pb-8 shadow-lg relative text-left"
                        >
                            <div className="w-12 h-1.5 bg-slate-100 rounded-full mx-auto mb-8 sm:hidden" />

                            <div className="text-center mb-8">
                                <h3 className="text-xl font-bold uppercase text-slate-900 mb-2">Gestionar Incidente</h3>
                            ...
                            <div className="space-y-4 mb-8">
                                <div className="space-y-2">
                                    <label className="text-[9px] font-bold uppercase text-slate-400 tracking-widest ml-1">Notas de Intervención</label>
                                    <textarea
                                        value={backupDetail}
                                        onChange={(e) => setBackupDetail(e.target.value)}
                                ...
                                <div className="grid grid-cols-1 gap-3">
                                    {activeMission.status === 'PENDING' && activeMission.requesterId !== socketRef.current?.id && (
                                        <button
                                            ...
                                            className="h-16 bg-blue-600 text-white rounded-2xl flex items-center justify-center gap-3 shadow-lg shadow-blue-600/20 active:scale-95 transition-all text-xs font-bold uppercase tracking-widest"
                                        >
                                    ...
                                    <button
                                        ...
                                        className="h-16 bg-emerald-600 text-white rounded-2xl flex items-center justify-center gap-3 shadow-lg shadow-emerald-600/20 active:scale-95 transition-all text-xs font-bold uppercase tracking-widest"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="h-14 bg-slate-100 text-slate-400 rounded-2xl flex items-center justify-center gap-3 active:scale-95 transition-all text-[10px] font-bold uppercase tracking-widest"
                                    >
                        ...
                        <div className="relative flex-1 bg-slate-900 flex items-center justify-center overflow-hidden">
                            ...
                            <div className="absolute top-10 left-6 right-6 flex justify-between items-start pointer-events-none">
                                <div className="bg-black/40 backdrop-blur-md px-4 py-2 rounded-2xl border border-white/10">
                                    <p className="text-[10px] font-bold uppercase text-white tracking-[0.2em]">Cámara En Vivo</p>
                                </div>
                                <button
                                    onClick={stopCamera}
                ...
                {showSettingsModal && (
                    ...
                    >
                        <header className="h-20 px-8 flex items-center justify-between shrink-0">
                            <h2 className="text-xl font-bold uppercase tracking-tight text-slate-900">Configuración</h2>
                        ...
                        <div className="flex-1 overflow-y-auto px-8 py-4 space-y-12">
                            ...
                            <div className="flex flex-col items-center gap-6">
                                <div className="relative">
                                    <div className="w-40 h-40 rounded-[40px] overflow-hidden bg-slate-100 border-4 border-white shadow-lg relative">
                                        {guardPhoto ? (
                                ...
                                <div className="text-center">
                                    <h3 className="text-2xl font-bold uppercase text-slate-900">{guardName}</h3>
                            ...
                            <div className="space-y-4">
                                ...
                                >
                                    ...
                                    <span className="text-blue-700 font-bold uppercase text-xs">Actualizar APP</span>
                                </button>
                                ...
                                >
                                    ...
                                    <span className="text-red-600 font-bold uppercase text-xs">Cerrar Sesión</span>
                                </button>
                            </div>

                            <div className="pt-8 text-center space-y-2">
                                <p className="text-[8px] font-bold text-slate-300 uppercase tracking-widest">OmniAccess Guard Mobile</p>
                                <p className="text-[8px] font-bold text-slate-300 uppercase tracking-widest">Versión 2.1.0-release</p>
                            </div>
                        </div>
                    </motion.div>
                )}
                ...
                {plateReport && (
                    ...
                    >
                        <motion.div
                            ...
                            animate={{ scale: 1, y: 0 }}
                            exit={{ scale: 0.9, y: 20 }}
                            className="w-full max-w-md bg-white rounded-2xl p-8 space-y-6 shadow-lg relative overflow-hidden"
                            onClick={(e) => e.stopPropagation()}
                        >
                            ...
                            <div className="flex justify-between items-start relative">
                                <div className="space-y-1">
                                    <h3 className="text-3xl font-bold tracking-tighter text-slate-900 leading-none">REPORTE</h3>
                                ...
                                <div className="bg-[#B20D30] px-4 py-2 rounded-xl shadow-lg shadow-[#B20D30]/20">
                                    <span className="text-white font-bold text-xl tracking-widest">{selectedEntry.plate || selectedEntry.plateDetected}</span>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="bg-slate-50 p-4 rounded-3xl border border-slate-100">
                                    ...
                                    <p className="text-lg font-bold text-[#B20D30]">{plateReport.totalEvents} <span className="text-[10px] text-slate-400">PASADAS</span></p>
                                </div>
                            </div>

                            <div className="space-y-3">
                                <p className="text-[9px] font-bold text-slate-900 uppercase tracking-[0.3em] ml-2">Últimos Movimientos</p>
                                <div className="space-y-2">
                            ...
                            <button
                                onClick={() => setPlateReport(null)}
                                className="w-full h-14 bg-slate-100 text-slate-900 rounded-3xl font-bold uppercase tracking-widest text-xs active:scale-95 transition-all"
                            >
                                CERRAR REPORTE
                            </button>
                        </motion.div>
            ...
            <AnimatePresence>
                {showUpdateSplash && (
                    ...
                    >
                        ...
                        <h2 className="text-3xl font-bold uppercase tracking-tighter mb-4 text-center">
                        ...
                        {updateAvailable && (
                            <div className="w-full max-w-sm space-y-4">
                                <button
                                    ...
                                    className="w-full h-18 bg-white text-blue-600 rounded-2xl font-bold uppercase tracking-widest text-xs active:scale-95 transition-all shadow-lg flex items-center justify-center gap-3"
                                >
                                    <Download size={18} /> Actualizar ahora
                                </button>
                                <button
                                    onClick={() => setShowUpdateSplash(false)}
                                    className="w-full h-18 bg-blue-700 text-white rounded-2xl font-bold uppercase tracking-widest text-xs active:scale-95 transition-all"
                                >
                                    Recordar más tarde
                                </button>
                            </div>
                ...
                {showSearchFillModal && recentRecords.length > 0 && (
                    ...
                    >
                        <motion.div
                            ...
                            animate={{ y: 0 }}
                            exit={{ y: "100%" }}
                            className="w-full bg-white rounded-t-[40px] p-8 pb-12 shadow-lg space-y-8"
                            onClick={(e) => e.stopPropagation()}
                        >
                            <div className="flex justify-center">
                            ...
                            <div className="space-y-2 text-center">
                                ...
                                <h3 className="text-2xl font-bold uppercase tracking-tight text-slate-900 leading-none">Registros Encontrados</h3>
                            ...
                            <button
                                onClick={() => setShowSearchFillModal(false)}
                                className="w-full h-16 bg-slate-100 text-slate-400 rounded-3xl font-bold uppercase tracking-widest text-xs active:bg-slate-200 transition-all"
                            >
...
function DetailFieldMobile({ label, value, icon }: any) {
    return (
        <div className="space-y-1">
            <p className="text-[8px] font-bold uppercase text-slate-400 tracking-widest flex items-center gap-1">
                {icon && React.isValidElement(icon) ? React.cloneElement(icon as any, { size: 10 }) : icon} {label}
            </p>
            <p className="text-xs font-bold uppercase text-slate-900 truncate">
                {value || "---"}
            </p>
        </div>
    );
...
function BottomNavItem({ icon, active, onClick, label }: any) {
    return (
        ...
        >
            ...
            <span className="text-[7px] md:text-[9px] font-bold uppercase tracking-widest">{label}</span>
        </button>
    );
}
...
function AppFieldMobile({ label, icon, value, onChange, placeholder }: any) {
    return (
        <div className="space-y-1 md:space-y-2">
            <Label className="text-[9px] md:text-[10px] font-bold uppercase text-slate-400 tracking-widest flex items-center gap-1.5 ml-1">
...
function TactilePlateInputMobile({ value, onChange, onCameraClick, playTactileSound }: { value: string, onChange: (v: string) => void, onCameraClick?: () => void, playTactileSound?: () => void }) {
    ...
    return (
        <div className="w-full flex flex-col gap-3 items-center relative">
            ...
            <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest z-10">Toca los cuadros para escribir</p>
        </div>
    );
}
