 ...
 *
 * La foto sin marco ni recuadro, tan grande como entre, y los datos encima. La idea es
 * poder mirar la matrícula: cualquier cosa que le robe lugar a la imagen está de más.
 * Los datos flotan en las esquinas y se mueven con el teclado entre avistamientos.
 */
function VisorCuadro({ fila, hayAnterior, haySiguiente, onAnterior, onSiguiente, onCerrar }: {
    fila: any; hayAnterior: boolean; haySiguiente: boolean;
    onAnterior: () => void; onSiguiente: () => void; onCerrar: () => void;
}) {
    useEffect(() => {
    ...
    return (
        <div onClick={onCerrar}
            ...
            {/* Matrícula y origen, arriba a la izquierda */}
            ...
            {/* Calidad de la lectura, arriba a la derecha */}
            ...
            {/* Pasar de un avistamiento al otro sin volver a la lista */}
            {hayAnterior && (
